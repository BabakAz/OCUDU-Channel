...
- After any doc restructure or section renumber, re-verify before reporting the turn complete that every internal anchor and every README->doc section-number citation still resolves; a renumber silently breaks "see §N" prose and cross-file links.
