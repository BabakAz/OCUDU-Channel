...
Status: **draft** · Builds on: [runtime-mutable-channel.md (v1, landed)](runtime-mutable-channel.md) · Phase target: **Phase 3.x** · Effort estimate: **~7–10 focused days** · Risk: **medium-high** (variable-size shadow + slot-counter coordination + delay-line warmup contract changes the parity story)
